...
_G.packer_plugins = {
  ...
  ["chatgpt.nvim"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/chatgpt.nvim",
  ...
  ["fzf.vim"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/fzf.vim",
  ...
  ["nvim-jdtls"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/nvim-jdtls",
  ...
  ["vim-elixir"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/vim-elixir",
    url = "https://github.com/elixir-editors/vim-elixir"
  },
  ["vim-svelte"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/vim-svelte",
